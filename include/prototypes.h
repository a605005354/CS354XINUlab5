...
/* in file mqinsert.c */
extern	struct msgqueue *mqinsert(umsg32, pid32);

extern	umsg32  mqextract(void);
extern syscall	send3(
	  pid32	,	
	  umsg32		
	);
...
extern process sendtest(pid32, umsg32);
extern process receivetest(void);
